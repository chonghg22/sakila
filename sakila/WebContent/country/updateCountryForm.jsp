...
<body>
		...
		<%
			...
			System.out.println(countryId + "/countryId/updateCountryForm");
		%>
...
<div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
		<div class="wrapper wrapper--w790">
			<div class="card card-5">
				...
				<div class="card-body">
					<form method = "post" action="<%=request.getContextPath()%>/country/updateCountryAction.jsp">
						<div class="form-row">
							<div class="name">
							CountryId:
							</div>
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="text" name="countryId" value ="<%=countryId %>" readonly>
								</div>
							</div>
						</div>
